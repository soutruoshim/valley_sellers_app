...
class SellerProvider extends ChangeNotifier {
  ...
  Future addProductImage(BuildContext context, XFile pickedLogo,String type, Function callback) async {
    _isLoading = true;
    notifyListeners();
    ApiResponse response = await shopRepo.addImage(context, pickedLogo, type);
    if(response.response != null && response.response.statusCode == 200) {
      _isLoading = false;
