...
class DeliveryManEarningList extends StatelessWidget {
            ...
            children: [
              ...
              Padding(
                ...
                child: TitleRow(title: getTranslated('earning_statement', context), onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (_)=> DeliveryManEarningViewAllScreen(deliveryMan: deliveryMan)));
                },),
              ),

              DeliverymanEarningListView(deliveryMan: deliveryMan),
            ],
          );
        }
      ),
